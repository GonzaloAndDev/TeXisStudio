...
const BROWSER_MOCKS: Record<string, unknown> = {
  ...
  compile_project: {
    success: true,
    pdf_path: "/demo/redes-neuronales/build/main.pdf",
    duration_ms: 1234,
    user_errors: [],
    warnings: [],
    log_preview: "This is XeTeX… Output written on main.pdf (11 pages).",
    backend_used: "latexmk",
    dependency_issues: [],
  ...
  recovery_list_snapshots: [
    { id: "1750000003000000000", created_unix_nanos: "1750000003000000000", files: ["tesis.project.yaml"], label: "pre-save" },
    { id: "1750000002000000000", created_unix_nanos: "1750000002000000000", files: ["tesis.project.yaml"], label: "pre-save" },
    { id: "1750000001000000000", created_unix_nanos: "1750000001000000000", files: ["tesis.project.yaml"], label: "pre-save" },
  ],
  recovery_restore_snapshot: 1,
  verify_integrity: [],
