...
const SYMBOLS: Record<Category, MathSymbol[]> = {
  ...
  operators: [
    ...
    { display: "lim", latex: "\\lim_{}",   title: "\\lim_{}  ·  Tab para saltar entre {}" },
  ...
  structures: [
    ...
    { display: "ⁿ√·",   latex: "\\sqrt[]{}",                                                          title: "\\sqrt[n]{x}  ·  Tab: índice → radicando" },
    { display: "xⁿ",    latex: "^{}",                                                                 title: "superíndice ^{}" },
    { display: "xₙ",    latex: "_{}",                                                                 title: "subíndice _{}" },
    { display: "x^n_m", latex: "^{}_{}",                                                              title: "sup + sub" },
    { display: "∑ᵢⁿ",   latex: "\\sum_{}^{}",                                                       title: "\\sum_{}^{}  ·  Tab para rellenar" },
    { display: "∏ᵢⁿ",   latex: "\\prod_{}^{}",                                                      title: "\\prod_{}^{}  ·  Tab para rellenar" },
    { display: "∫ₐᵇ",   latex: "\\int_{}^{}",                                                       title: "\\int_{}^{}  ·  Tab para rellenar" },
    { display: "lim→",  latex: "\\lim_{}",                                                          title: "\\lim_{x \\to a}  ·  llena el límite" },
