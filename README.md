...
| Test frontend | `npm test` (in `texis-app/`) | 331 tests for stores, services, i18n coverage, UI helpers, document history, visual-editor transforms, metadata round-trips, and serializer round-trips. |
...
| Probar frontend | `npm test` (en `texis-app/`) | 331 pruebas de stores, servicios, cobertura i18n, historial de documento, transforms, recorridos de metadata y round-trips de serialización. |
